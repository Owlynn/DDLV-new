...
const ENV = {
  ...
  BILLETWEB_PROXY_URL: env.BILLETWEB_PROXY_URL || '/api/billetweb',
...
const BILLETWEB_CONFIG = {
  proxyUrl: env.BILLETWEB_PROXY_URL || '/api/billetweb',
...
if (!env.EMAILJS_PUBLIC_KEY && !env.BILLETWEB_PROXY_URL) {
