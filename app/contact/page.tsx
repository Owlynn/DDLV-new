  ...
  return (
    <main className="flex-1 overflow-y-auto relative" role="main">
      <section className="hero-overlay relative h-screen overflow-hidden flex items-center pt-20 sm:pt-24 pb-12 md:pb-24" aria-label="Contact" id="contact">
        <div className="w-full max-w-5xl mx-auto px-4 md:px-8 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 md:gap-10 lg:gap-16">
          <div className="flex flex-col gap-6 max-w-xl">
            <h1 className="text-[2rem] sm:text-[2.8rem] md:text-[4rem] lg:text-[4.8rem] font-bold tracking-tight text-white leading-tight">
      ...
      <section className="hero-overlay relative flex items-center py-12 md:py-24 scroll-mt-24" aria-label="Newsletter" id="newsletter">
        <div className="w-full max-w-5xl mx-auto px-4 md:px-8 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 md:gap-10 lg:gap-16">
          <div className="flex flex-col gap-6 max-w-xl">
            <h2 className="text-[2rem] sm:text-[2.4rem] md:text-[3.2rem] lg:text-[4rem] font-bold tracking-tight text-white leading-tight">
